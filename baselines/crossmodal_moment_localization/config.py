...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--pseudo_query_dest_path", type=str, default=None, help="")
        self.parser.add_argument("--visual_pseudo_query_bert_path", type=str, default=None, help="")
        self.parser.add_argument("--textual_pseudo_query_bert_path", type=str, default=None, help="")
        ...
        self.parser.add_argument("--pseudo_data_ratio", type=float, default=1, help="")
        ...
        self.parser.add_argument("--max_es_cnt", type=int, default=-1,
        ...
        self.parser.add_argument("--training_w_pseudo_supervision", action="store_true",
                                 help="this allows training the model with pseudo-supervision.")
        self.parser.add_argument("--training_strategy", type=str, default="aug", help="which training strategy to use",
                                 choices=["visual", "textual", "aug"])
