...
case ${dset_name} in
    tvr)
        ...
        # Please check the path and files are correct.
          pseudo_query_dest_path=data/tvr_pseudo_query_info_by_subtitle_based_2_5.jsonl
          visual_pseudo_query_bert_path=${feature_root}/bert_feature/sub_query/tvr_visual_pseudo_query_pretrained_w_sub_query.h5
          textual_pseudo_query_bert_path=${feature_root}/bert_feature/sub_query/tvr_textual_pseudo_query_pretrained_w_sub_query.h5

          extra_args+=(--visual_pseudo_query_bert_path)
          extra_args+=(${visual_pseudo_query_bert_path})
          extra_args+=(--textual_pseudo_query_bert_path)
          extra_args+=(${textual_pseudo_query_bert_path})
...
PYTHONPATH=$PYTHONPATH:. python baselines/crossmodal_moment_localization/train.py \
--dset_name=${dset_name} \
--eval_split_name=${eval_split_name} \
--nms_thd=${nms_thd} \
--results_root=${results_root} \
--train_path=${train_path} \
--pseudo_query_dest_path=${pseudo_query_dest_path} \
