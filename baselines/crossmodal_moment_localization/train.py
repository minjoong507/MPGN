...
from baselines.crossmodal_moment_localization.start_end_dataset import \
    StartEndDataset, start_end_collate, StartEndEvalDataset, prepare_batch_inputs, Pseudo_query_StartEndDataset
...
def start_training():
    ...
    if opt.training_w_pseudo_supervision:
        train_dataset = Pseudo_query_StartEndDataset(
            dset_name=opt.dset_name,
            data_path=opt.pseudo_query_dest_path,
            visual_pseudo_query_bert_or_handler=opt.visual_pseudo_query_bert_path,
            textual_pseudo_query_bert_path_or_handler=opt.textual_pseudo_query_bert_path,
